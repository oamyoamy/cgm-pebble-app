...
void show_chart(const char* bgVal, int bgArray[]) {
  //APP_LOG(APP_LOG_LEVEL_DEBUG, "bgArray 0: %d", bgArray[0]);
  //APP_LOG(APP_LOG_LEVEL_DEBUG, "bgArray 1: %d", bgArray[1]);
  //APP_LOG(APP_LOG_LEVEL_DEBUG, "bgArray 2: %d", bgArray[2]);
  //APP_LOG(APP_LOG_LEVEL_DEBUG, "bgArray 3: %d", bgArray[3]);
  //APP_LOG(APP_LOG_LEVEL_DEBUG, "bgArray 4: %d", bgArray[4]);
  //APP_LOG(APP_LOG_LEVEL_DEBUG, "bgArray 5: %d", bgArray[5]);
